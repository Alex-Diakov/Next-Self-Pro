      ...
      <div className="relative z-10 flex flex-col h-full">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2 text-xs font-medium text-muted bg-white/5 px-3 py-1.5 rounded-full border border-white/5">
            <span className="w-2 h-2 rounded-full bg-success-muted animate-pulse"></span>
            AI Engine Ready
          </div>
        </div>

        <div className="flex-1 border-2 border-dashed border-white/10 rounded-3xl bg-background/50 hover:bg-white/5 hover:border-accent/40 transition-all duration-500 group cursor-pointer flex flex-col items-center justify-center p-10 text-center min-h-[500px]">
